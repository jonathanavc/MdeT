...
nvcc ./cuda/Cuda.cu -lz -std=c++17 -lboost_program_options -lboost_filesystem -lboost_graph -lboost_math -O3 -arch=native -lineinfo -Xcompiler="-pthread -fopenmp" -o metabatcuda
