...
nvcc ./cuda/Cuda.cu -std=c++17 -lboost_program_options -lboost_filesystem -lboost_graph -lboost_serialization -lboost_system -O3 -arch=native -lineinfo -use_fast_math -Xcompiler="-pthread -fopenmp" -o metabatcuda
