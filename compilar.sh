...
nvcc ./cuda/Cuda2.cu --default-stream per-thread -std=c++17 -o1 -lboost_program_options -lboost_filesystem -lboost_graph -lboost_serialization -lboost_system -arch=native -lineinfo -Xcompiler="-march=native -pthread -fopenmp" -o metabatcuda2
