...
nvcc ./cuda/Cuda.cu -lz -std=c++17 -lboost_program_options -lboost_filesystem -lboost_graph -O3 -arch=native -lineinfo -Xcompiler="-march=native -pthread -fopenmp" -o metabatcuda
