...
nvcc ./cuda/Cuda.cu -lz -std=c++17 -lboost_program_options -lboost_filesystem -lboost_graph -O3 -arch=native -lineinfo -Xcompiler="-xCOMMON-AVX512 -pthread -fopenmp" -o metabatcuda
