...
nvcc ./cuda/Cuda.cu -lz -std=c++17 -lboost_program_options -lboost_filesystem -lboost_graph -lboost_serialization -lboost_system -O3 -arch=native --use_fast_math --expt-relaxed-constexpr -lineinfo -Xcompiler="-march=native -pthread -fopenmp" -o metabatcuda
