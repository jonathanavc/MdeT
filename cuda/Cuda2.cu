    ...
    for (size_t ii = 0; ii < nobs; ii += TILE) {
        ...
        for (size_t jj = 0; jj < nobs; jj += TILE) {
            ...
            if (jj == 0) {
                ...
                get_tnf_graph2<<<matrix_x, numThreads2>>>(graph_d, TNF_d, contig_log, matrix_y, matrix_x, ii, jj,
            ...
            if (jj + TILE <= nobs) {
                ...
                // floor_preProb_cutoff);
                get_tnf_graph2<<<matrix_next_x, numThreads2>>>(graph_d, TNF_d, contig_log, matrix_y, matrix_next_x, ii, jj + TILE,
                                                               floor_preProb_cutoff);
            }
