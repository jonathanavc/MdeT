...
#include "extra/OpenMP.h"
#include "extra/ProgressTracker.h"
#include "extra/igraph.h"
//#include "kseq.h"
...
static const std::string version = "cudaMetabat v0.1";
static const std::string DATE = "14-07-2023";
