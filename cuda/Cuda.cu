...
__device__ double cal_tnf_dist(size_t r1, size_t r2, double *TNF, size_t *seqs_d_index, size_t seqs_d_index_size) {
    ...
    b = (double)(46349.1624324381) + (double)(-76092.3748553155) * lw11 + (double)(-639.918334183) * lw21 +
        (double)(53873.3933743949) * lw12 + (double)(-156.6547554844) * lw22 + (double)(-21263.6010657275) * lw13 +
        (double)(64.7719132839) * lw23 + (double)(5003.2646455284) * lw14 + (double)(-8.5014386744) * lw24 +
        (double)(-700.5825500292) * lw15 + (double)(0.3968284526) * lw25 + (double)(54.037542743) * lw16 +
        (double)(-1.7713972342) * lw17 + (double)(474.0850141891) * lw11 * lw21 + (double)(-23.966597785) * lw12 * lw22 +
        (double)(0.7800219061) * lw13 * lw23 + (double)(-0.0138723693) * lw14 * lw24 + (double)(0.0001027543) * lw15 * lw25;
