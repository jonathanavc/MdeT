...
__device__ double cal_tnf_dist(size_t r1, size_t r2, double *TNF, size_t *seqs_d_index, size_t seqs_d_index_size) {
    ...
    // return min ctg1;
    double lw1 = log10((double)min(ctg1, ctg2));
    double lw2 = log10((double)max(ctg1, ctg2));
    // return lw1;
    double lw3 = lw1 * lw1;
    double lw4 = lw3 * lw1;
    double lw5 = lw4 * lw1;
    ...
    double lw9 = lw2 * lw2;
    double lw10 = lw9 * lw2;
    double lw11 = lw10 * lw2;
    double lw12 = lw11 * lw2;
    double lw13 = lw12 * lw2;

    double prob;

    b = 46349.1624324381 + -76092.3748553155 * lw1 + -639.918334183 * lw2 + 53873.3933743949 * lw3 + -156.6547554844 * lw9 +
        -21263.6010657275 * lw4 + 64.7719132839 * lw10 + 5003.2646455284 * lw5 + -8.5014386744 * lw11 + -700.5825500292 * lw6 +
        0.3968284526 * lw12 + 54.037542743 * lw7 + -1.7713972342 * lw8 + 474.0850141891 * lw1 * lw2 + -23.966597785 * lw3 * lw9 +
        0.7800219061 * lw4 * lw10 + -0.0138723693 * lw5 * lw11 + 0.0001027543 * lw6 * lw12;
    c = -443565.465710869 + 718862.10804858 * lw1 + 5114.1630934534 * lw2 + -501588.206183097 * lw3 + 784.4442123743 * lw9 +
        194712.394138513 * lw4 + -377.9645994741 * lw10 + -45088.7863182741 * lw5 + 50.5960513287 * lw11 + 6220.3310639927 * lw6 +
        -2.3670776453 * lw12 + -473.269785487 * lw7 + 15.3213264134 * lw8 + -3282.8510348085 * lw1 * lw2 +
        164.0438603974 * lw3 * lw9 + -5.2778800755 * lw4 * lw10 + 0.0929379305 * lw5 * lw11 + -0.0006826817 * lw6 * lw12;
    ...
    if (prob >= .1) {  // second logistic model
        b = 6770.9351457442 + -5933.7589419767 * lw1 + -2976.2879986855 * lw2 + 3279.7524685865 * lw3 + 1602.7544794819 * lw9 +
            -967.2906583423 * lw4 + -462.0149190219 * lw10 + 159.8317289682 * lw5 + 74.4884405822 * lw11 + -14.0267151808 * lw6 +
            -6.3644917671 * lw12 + 0.5108811613 * lw7 + 0.2252455343 * lw13 + 0.965040193 * lw3 * lw9 +
            -0.0546309127 * lw4 * lw10 + 0.0012917084 * lw5 * lw11 + -1.14383e-05 * lw6 * lw12;
        c = 39406.5712626297 + -77863.1741143294 * lw1 + 9586.8761567725 * lw2 + 55360.1701572325 * lw3 + -5825.2491611377 * lw9 +
            -21887.8400068324 * lw4 + 1751.6803621934 * lw10 + 5158.3764225203 * lw5 + -290.1765894829 * lw11 +
            -724.0348081819 * lw6 + 25.364646181 * lw12 + 56.0522105105 * lw7 + -0.9172073892 * lw13 + -1.8470088417 * lw8 +
            449.4660736502 * lw1 * lw2 + -24.4141920625 * lw3 * lw9 + 0.8465834103 * lw4 * lw10 + -0.0158943762 * lw5 * lw11 +
            0.0001235384 * lw6 * lw12;
...
const double _b[] = {46349.1624324381, -76092.3748553155, -639.918334183, 53873.3933743949, -21263.6010657275, 5003.2646455284,
                     -700.5825500292,  54.037542743,      -1.7713972342,  -156.6547554844,  64.7719132839,     -8.5014386744,
                     0.3968284526,     474.0850141891,    -23.966597785,  0.7800219061,     -0.0138723693,     0.0001027543};

const double _c[] = {-443565.465710869, 718862.10804858,  5114.1630934534, -501588.206183097, 194712.394138513, -45088.7863182741,
                     6220.3310639927,   -473.269785487,   15.3213264134,   784.4442123743,    -377.9645994741,  50.5960513287,
                     -2.3670776453,     -3282.8510348085, 164.0438603974,  -5.2778800755,     0.0929379305,     -0.0006826817};
...
Distance cal_tnf_dist(size_t r1, size_t r2) {
    ...
    */
    ...
    __m512d aux1 = _mm512_loadu_pd(_b + 1);
    __m256d aux2 = _mm256_loadu_pd(_b + 9);
    b = _b[0];
    b += _mm512_reduce_add_pd(_mm512_mul_pd(aux1, _mm512_loadu_pd(lw)));
    b += _mm256_reduce_add_pd(_mm256_mul_pd(aux2, _mm256_loadu_pd(lw + 8)));
    ...
    /**
    b = 46349.1624324381
    + -76092.3748553155 * lw[0]
    + -639.918334183 * lw[1]
    + 53873.3933743949 * lw[2]
    + -21263.6010657275 * lw[3]
    + 5003.2646455284 * lw[4]
    + -700.5825500292 * lw[5]
    + 54.037542743 * lw[6]
    + -1.7713972342 * lw[7]
    + -156.6547554844 * lw[8]
    ...
    + -8.5014386744 * lw[10]
    + 0.3968284526 * lw[11]
    + 474.0850141891 * lw[0] * lw[1]
    + -23.966597785 * lw[2] * lw[8]
    + 0.7800219061 * lw[3] * lw[9]
    + -0.0138723693 * lw[4] * lw[10]
    + 0.0001027543 * lw[5] * lw[11];
    */
    aux1 = _mm512_loadu_pd(_c + 1);
    aux2 = _mm256_loadu_pd(_c + 9);

    c = _c[0];
    c += _mm512_reduce_add_pd(_mm512_mul_pd(aux1, _mm512_loadu_pd(lw)));
    c += _mm256_reduce_add_pd(_mm256_mul_pd(aux2, _mm256_loadu_pd(lw + 8)));
    ...
    + 5114.1630934534 * lw[1]
    + -501588.206183097 * lw[2]
    + 194712.394138513 * lw[3]
    + -45088.7863182741 * lw[4]
    + 6220.3310639927 * lw[5]
    + -473.269785487 * lw[6]
    + 15.3213264134 * lw[7]
    + 784.4442123743 * lw[8]
    + -377.9645994741 * lw[9]
    + 50.5960513287 * lw[10]
    + -2.3670776453 * lw[11]
    + -3282.8510348085 * lw[0] * lw[1]
    + 164.0438603974 * lw[2] * lw[8]
    + -5.2778800755 * lw[3] * lw[9]
    + 0.0929379305 * lw[4] * lw[10]
    + -0.0006826817 * lw[5] * lw[11];
    */
