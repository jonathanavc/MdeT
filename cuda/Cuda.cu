...
__device__ double cal_tnf_dist_d(size_t r1, size_t r2, float *TNF, size_t *seqs_d_index, size_t seqs_d_index_size) {
    ...
    b = 46349.1624324381 + -76092.3748553155 * lw[0] + -639.918334183 * lw[1] + 53873.3933743949 * lw[2] + -156.6547554844 * lw[3] +
        ...
        0.3968284526 * lw[9] + 54.037542743 * lw[10] + -1.7713972342 * lw[11] + 474.0850141891 * lw[0] * lw[1] +
        -23.966597785 * lw[13] + 0.7800219061 * lw[4] * lw[5] + -0.0138723693 * lw[6] * lw[7] + 0.0001027543 * lw[8] * lw[9];
    c = -443565.465710869 + 718862.10804858 * lw[0] + 5114.1630934534 * lw[1] + -501588.206183097 * lw[2] + 784.4442123743 * lw[3] +
        ...
        -3282.8510348085 * lw[0] * lw[1] + 164.0438603974 * lw[13] + -5.2778800755 * lw[4] * lw[5] + 0.0929379305 * lw[6] * lw[7] +
    ...
    if (prob >= .1) {
        ...
        c = 39406.5712626297 + -77863.1741143294 * lw[0] + 9586.8761567725 * lw[1] + 55360.1701572325 * lw[2] +
            ...
            -0.9172073892 * lw[18] + -1.8470088417 * lw[11] + 449.4660736502 * lw[0] * lw[1] + -24.4141920625 * lw[13] +
            0.8465834103 * lw[4] * lw[5] + -0.0158943762 * lw[6] * lw[7] + 0.0001235384 * lw[8] * lw[9];
