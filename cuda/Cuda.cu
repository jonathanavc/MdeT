...
Distance cal_tnf_dist(size_t r1, size_t r2) {
    ...
    */
    ...
    Distance b_plus_c = -397216.3032784309 - 642769.7331932645 * lw11 + 4474.2447592704 * lw21 + 451714.186190297 * lw12 +
                        -631.2095421101 * lw22 + -157712.2069272135 * lw13 + 314.8063138098 * lw23 + 37337.4986722536 * lw14 +
    ...
    if (prob >= .1) {  // second logistic model
        ...
        c = 39406.5712626297 + -77863.1741143294 * lw11 + 9586.8761567725 * lw21 + 55360.1701572325 * lw12 + -5825.2491611377 * lw22 +
            ...
            0.0001235384 * lw15 * lw25;
        */
        b_plus_c = 46177.5064083739 + -83796.9330563061 * lw11 + 6609.588158087 * lw21 + 58640.922625819 * lw12 + -6457.4587032478 * lw22 +
                   -22785.1306686399 * lw13 + 2066.4866750032 * lw23 + 5317.2081514885 * lw14 + -215.8121499007 * lw24 +
                   -729.2113973638 * lw15 + 25.364646181 * lw25 + 56.0522105105 * lw16 + -0.9172073892 * lw26 + -1.8470088417 * lw17 +
                   449.4660736502 * lw11 * lw21 + -24.4141920625 * lw12 * lw22 + 0.8465834103 * lw13 * lw23 +
                   -0.0158943762 * lw14 * lw24 + 0,0001121001 * lw15 * lw25;
        prob = 1.0 / (1 + exp(-(b_plus_c * d)));
        prob = prob < .1 ? .1 : prob;
    }
