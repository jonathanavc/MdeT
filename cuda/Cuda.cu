...
__device__ double cal_tnf_dist_d(size_t r1, size_t r2, float *TNF, size_t *seqs_d_index, size_t seqs_d_index_size) {
    ...
    double lw14 = lw[4] * lw[0];
    double lw15 = lw14 * lw[0];
    double lw16 = lw15 * lw[0];
    double lw17 = lw16 * lw[0];
    double lw[3] = lw[1] * lw[1];
    double lw[5] = lw[3] * lw[1];
    double lw24 = lw[5] * lw[1];
    double lw25 = lw24 * lw[1];
    double lw26 = lw25 * lw[1];
    double prob;
    b = 46349.1624324381 + -76092.3748553155 * lw[0] + -639.918334183 * lw[1] + 53873.3933743949 * lw[2] + -156.6547554844 * lw[3] +
        -21263.6010657275 * lw[4] + 64.7719132839 * lw[5] + 5003.2646455284 * lw14 + -8.5014386744 * lw24 + -700.5825500292 * lw15 +
        0.3968284526 * lw25 + 54.037542743 * lw16 + -1.7713972342 * lw17 + 474.0850141891 * lw[0] * lw[1] + -23.966597785 * lw[2] * lw[3] +
        0.7800219061 * lw[4] * lw[5] + -0.0138723693 * lw14 * lw24 + 0.0001027543 * lw15 * lw25;
    c = -443565.465710869 + 718862.10804858 * lw[0] + 5114.1630934534 * lw[1] + -501588.206183097 * lw[2] + 784.4442123743 * lw[3] +
        194712.394138513 * lw[4] + -377.9645994741 * lw[5] + -45088.7863182741 * lw14 + 50.5960513287 * lw24 + 6220.3310639927 * lw15 +
        -2.3670776453 * lw25 + -473.269785487 * lw16 + 15.3213264134 * lw17 + -3282.8510348085 * lw[0] * lw[1] +
        164.0438603974 * lw[2] * lw[3] + -5.2778800755 * lw[4] * lw[5] + 0.0929379305 * lw14 * lw24 + -0.0006826817 * lw15 * lw25;
    ...
    if (prob >= .1) {
        b = 6770.9351457442 + -5933.7589419767 * lw[0] + -2976.2879986855 * lw[1] + 3279.7524685865 * lw[2] + 1602.7544794819 * lw[3] +
            -967.2906583423 * lw[4] + -462.0149190219 * lw[5] + 159.8317289682 * lw14 + 74.4884405822 * lw24 + -14.0267151808 * lw15 +
            -6.3644917671 * lw25 + 0.5108811613 * lw16 + 0.2252455343 * lw26 + 0.965040193 * lw[2] * lw[3] +
            -0.0546309127 * lw[4] * lw[5] + 0.0012917084 * lw14 * lw24 + -1.14383e-05 * lw15 * lw25;
        c = 39406.5712626297 + -77863.1741143294 * lw[0] + 9586.8761567725 * lw[1] + 55360.1701572325 * lw[2] + -5825.2491611377 * lw[3] +
            -21887.8400068324 * lw[4] + 1751.6803621934 * lw[5] + 5158.3764225203 * lw14 + -290.1765894829 * lw24 +
            -724.0348081819 * lw15 + 25.364646181 * lw25 + 56.0522105105 * lw16 + -0.9172073892 * lw26 + -1.8470088417 * lw17 +
            449.4660736502 * lw[0] * lw[1] + -24.4141920625 * lw[2] * lw[3] + 0.8465834103 * lw[4] * lw[5] + -0.0158943762 * lw14 * lw24 +
...
Distance cal_tnf_dist(size_t r1, size_t r2) {
    ...
    */
    ...
    Distance lw14 = lw[4] * lw[0];
    Distance lw15 = lw14 * lw[0];
    Distance lw16 = lw15 * lw[0];
    Distance lw17 = lw16 * lw[0];
    Distance lw[3] = lw[1] * lw[1];
    Distance lw[5] = lw[3] * lw[1];
    Distance lw24 = lw[5] * lw[1];
    Distance lw25 = lw24 * lw[1];
    Distance lw26 = lw25 * lw[1];
    Distance lw31 = lw[0] * lw[1];
    Distance lw32 = lw[4] * lw[5];
    Distance lw33 = lw14 * lw24;
    Distance lw34 = lw15 * lw25;

    Distance prob;

    b = 46349.1624324381 + -76092.3748553155 * lw[0] + -639.918334183 * lw[1] + 53873.3933743949 * lw[2] + -156.6547554844 * lw[3] +
        -21263.6010657275 * lw[4] + 64.7719132839 * lw[5] + 5003.2646455284 * lw14 + -8.5014386744 * lw24 + -700.5825500292 * lw15 +
        0.3968284526 * lw25 + 54.037542743 * lw16 + -1.7713972342 * lw17 + 474.0850141891 * lw31 + -23.966597785 * lw[2] * lw[3] +
        0.7800219061 * lw32 + -0.0138723693 * lw33 + 0.0001027543 * lw34;
    c = -443565.465710869 + 718862.10804858 * lw[0] + 5114.1630934534 * lw[1] + -501588.206183097 * lw[2] + 784.4442123743 * lw[3] +
        194712.394138513 * lw[4] + -377.9645994741 * lw[5] + -45088.7863182741 * lw14 + 50.5960513287 * lw24 + 6220.3310639927 * lw15 +
        -2.3670776453 * lw25 + -473.269785487 * lw16 + 15.3213264134 * lw17 + -3282.8510348085 * lw31 + 164.0438603974 * lw[2] * lw[3] +
        -5.2778800755 * lw32 + 0.0929379305 * lw33 + -0.0006826817 * lw34;
    ...
    if (prob >= .1) {  // second logistic model
        b = 6770.9351457442 + -5933.7589419767 * lw[0] + -2976.2879986855 * lw[1] + 3279.7524685865 * lw[2] + 1602.7544794819 * lw[3] +
            -967.2906583423 * lw[4] + -462.0149190219 * lw[5] + 159.8317289682 * lw14 + 74.4884405822 * lw24 + -14.0267151808 * lw15 +
            -6.3644917671 * lw25 + 0.5108811613 * lw16 + 0.2252455343 * lw26 + 0.965040193 * lw[2] * lw[3] + -0.0546309127 * lw32 +
            0.0012917084 * lw33 + -1.14383e-05 * lw34;
        c = 39406.5712626297 + -77863.1741143294 * lw[0] + 9586.8761567725 * lw[1] + 55360.1701572325 * lw[2] + -5825.2491611377 * lw[3] +
            -21887.8400068324 * lw[4] + 1751.6803621934 * lw[5] + 5158.3764225203 * lw14 + -290.1765894829 * lw24 +
            -724.0348081819 * lw15 + 25.364646181 * lw25 + 56.0522105105 * lw16 + -0.9172073892 * lw26 + -1.8470088417 * lw17 +
            449.4660736502 * lw31 + -24.4141920625 * lw[2] * lw[3] + 0.8465834103 * lw32 + -0.0158943762 * lw33 + 0.0001235384 * lw34;
        prob = 1.0 / (1 + exp(-(b + c * d)));
        prob = prob < .1 ? .1 : prob;
    }
