...
static const double _b1_h[18] = {46349.1624324381,  -76092.3748553155, -639.918334183,  53873.3933743949, -156.6547554844,
                                 -21263.6010657275, 64.7719132839,     5003.2646455284, -8.5014386744,    -700.5825500292,
                                 0.3968284526,      54.037542743,      -1.7713972342,   474.0850141891,   -23.966597785,
                                 0.7800219061,      -0.0138723693,     0.0001027543};
static const double _c1_h[18] = {-443565.465710869, 718862.10804858, 5114.1630934534,   -501588.206183097, 784.4442123743,
                                 194712.394138513,  -377.9645994741, -45088.7863182741, 50.5960513287,     6220.3310639927,
                                 -2.3670776453,     -473.269785487,  15.3213264134,     -3282.8510348085,  164.0438603974,
                                 -5.2778800755,     0.0929379305,    -0.0006826817};
static const double _b2_h[17] = {6770.9351457442, -5933.7589419767, -2976.2879986855, 3279.7524685865, 1602.7544794819,
                                 -967.2906583423, -462.0149190219,  159.8317289682,   74.4884405822,   -14.0267151808,
                                 -6.3644917671,   0.5108811613,     0.2252455343,     0.965040193,     -0.0546309127,
                                 0.0012917084,    -1.14383e-05};
static const double _c2_h[19] = {39406.5712626297,  -77863.1741143294, 9586.8761567725, 55360.1701572325, -5825.2491611377,
                                 -21887.8400068324, 1751.6803621934,   5158.3764225203, -290.1765894829,  -724.0348081819,
                                 25.364646181,      56.0522105105,     -0.9172073892,   -1.8470088417,    449.4660736502,
                                 -24.4141920625,    0.8465834103,      -0.0158943762,   0.0001235384};
...
Distance cal_tnf_dist(size_t r1, size_t r2) {
    ...
    b = _b1_h[0] + _b1_h[1] * lw[0] + _b1_h[2] * lw[1] + _b1_h[3] * lw[2] + _b1_h[4] * lw[3] + _b1_h[5] * lw[4] + _b1_h[6] * lw[5] +
        _b1_h[7] * lw[6] + _b1_h[8] * lw[7] + _b1_h[9] * lw[8] + _b1_h[10] * lw[9] + _b1_h[11] * lw[10] + _b1_h[12] * lw[11] +
        _b1_h[13] * lw[12] + _b1_h[14] * lw[13] + _b1_h[15] * lw[14] + _b1_h[16] * lw[15] + _b1_h[17] * lw[16];

    c = _c1_h[0] + _c1_h[1] * lw[0] + _c1_h[2] * lw[1] + _c1_h[3] * lw[2] + _c1_h[4] * lw[3] + _c1_h[5] * lw[4] + _c1_h[6] * lw[5] +
        _c1_h[7] * lw[6] + _c1_h[8] * lw[7] + _c1_h[9] * lw[8] + _c1_h[10] * lw[9] + _c1_h[11] * lw[10] + _c1_h[12] * lw[11] +
        _c1_h[13] * lw[12] + _c1_h[14] * lw[13] + _c1_h[15] * lw[14] + _c1_h[16] * lw[15] + _c1_h[17] * lw[16];
    prob = 1.0 / (1 + exp(-(b + c * d)));

    if (prob >= .1) {
        b = _b2_h[0] + _b2_h[1] * lw[0] + _b2_h[2] * lw[1] + _b2_h[3] * lw[2] + _b2_h[4] * lw[3] + _b2_h[5] * lw[4] +
            _b2_h[6] * lw[5] + _b2_h[7] * lw[6] + _b2_h[8] * lw[7] + _b2_h[9] * lw[8] + _b2_h[10] * lw[9] + _b2_h[11] * lw[10] +
            _b2_h[12] * lw[18] + _b2_h[13] * lw[13] + _b2_h[14] * lw[14] + _b2_h[15] * lw[15] + _b2_h[16] * lw[16];
        c = _c2_h[0] + _c2_h[1] * lw[0] + _c2_h[2] * lw[1] + _c2_h[3] * lw[2] + _c2_h[4] * lw[3] + _c2_h[5] * lw[4] +
            _c2_h[6] * lw[5] + _c2_h[7] * lw[6] + _c2_h[8] * lw[7] + _c2_h[9] * lw[8] + _c2_h[10] * lw[9] + _c2_h[11] * lw[10] +
            _c2_h[12] * lw[18] + _c2_h[13] * lw[11] + _c2_h[14] * lw[12] + _c2_h[15] * lw[13] + _c2_h[16] * lw[14] +
            _c2_h[17] * lw[15] + _c2_h[18] * lw[16];
        prob = 1.0 / (1 + exp(-(b + c * d)));
        prob = prob < .1 ? .1 : prob;
    }
    return prob;
