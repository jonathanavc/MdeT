...
Distance cal_tnf_dist(size_t r1, size_t r2) {
    ...
    */
    ...
    Distance _b1[16] = {-76092.3748553155, -639.918334183, 53873.3933743949, -156.6547554844, -21263.6010657275, 64.7719132839,
    ...
    b512 = _mm512_mul_pd(b512, _mm512_set_pd(-76092.3748553155, -639.918334183, 53873.3933743949, -156.6547554844, -21263.6010657275,
                                             64.7719132839, 5003.2646455284, -8.5014386744));
    b += _mm512_reduce_add_pd(b512);
    b512 = _mm512_load_pd(lw + 8);
    b512 = _mm512_mul_pd(b512, _mm512_set_pd(-700.5825500292, 0.3968284526, 54.037542743, -1.7713972342, 474.0850141891, -23.966597785,
                                             0.7800219061, -0.0138723693));
    b += _mm512_reduce_add_pd(b512);
    ...
    + -156.6547554844 * lw[3]
    + -21263.6010657275 * lw[4]
    + 64.7719132839 * lw[5]
    + 5003.2646455284 * lw[6]
    + -8.5014386744 * lw[7]
    + -700.5825500292 * lw[8]
    + 0.3968284526 * lw[9]
    + 54.037542743 * lw[10]
    + -1.7713972342 * lw[11]
    + 474.0850141891 * lw[12]
    + -23.966597785 * lw[13]
    + 0.7800219061 * lw[14]
    + -0.0138723693 * lw[15]
    + 0.0001027543 * lw[16];
