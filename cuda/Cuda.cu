...
__device__ double cal_tnf_dist(size_t r1, size_t r2, double *TNF, size_t *seqs_d_index, size_t seqs_d_index_size) {
    ...
    b = 46349.1624324381 + -76092.3748553155 * lw[0] + -639.918334183 * lw[1] + 53873.3933743949 * lw[2] + -156.6547554844 * lw[3] +
        ...
        0.3968284526 * lw[9] + 54.037542743 * lw[10] + -1.7713972342 * lw[11] + 474.0850141891 * lw[0] * lw[1] + -23.966597785 * lw[2] * lw[3] +
        0.7800219061 * lw[4] * lw[5] + -0.0138723693 * lw[6] * lw[7] + 0.0001027543 * lw[8] * lw[9];
    c = -443565.465710869 + 718862.10804858 * lw[0] + 5114.1630934534 * lw[1] + -501588.206183097 * lw[2] + 784.4442123743 * lw[3] +
        194712.394138513 * lw[4] + -377.9645994741 * lw[5] + -45088.7863182741 * lw[6] + 50.5960513287 * lw[7] + 6220.3310639927 * lw[8] +
        -2.3670776453 * lw[9] + -473.269785487 * lw[10] + 15.3213264134 * lw[11] + -3282.8510348085 * lw[0] * lw[1] +
        164.0438603974 * lw[2] * lw[3] + -5.2778800755 * lw[4] * lw[5] + 0.0929379305 * lw[6] * lw[7] + -0.0006826817 * lw[8] * lw[9];
    ...
    if (prob >= .1) {  // second logistic model
        b = 6770.9351457442 + -5933.7589419767 * lw[0] + -2976.2879986855 * lw[1] + 3279.7524685865 * lw[2] + 1602.7544794819 * lw[3] +
            -967.2906583423 * lw[4] + -462.0149190219 * lw[5] + 159.8317289682 * lw[6] + 74.4884405822 * lw[7] + -14.0267151808 * lw[8] +
            -6.3644917671 * lw[9] + 0.5108811613 * lw[10] + 0.2252455343 * lw[12] + 0.965040193 * lw[2] * lw[3] +
            -0.0546309127 * lw[4] * lw[5] + 0.0012917084 * lw[6] * lw[7] + -1.14383e-05 * lw[8] * lw[9];
        c = 39406.5712626297 + -77863.1741143294 * lw[0] + 9586.8761567725 * lw[1] + 55360.1701572325 * lw[2] + -5825.2491611377 * lw[3] +
            -21887.8400068324 * lw[4] + 1751.6803621934 * lw[5] + 5158.3764225203 * lw[6] + -290.1765894829 * lw[7] +
            -724.0348081819 * lw[8] + 25.364646181 * lw[9] + 56.0522105105 * lw[10] + -0.9172073892 * lw[12] + -1.8470088417 * lw[11] +
            449.4660736502 * lw[0] * lw[1] + -24.4141920625 * lw[2] * lw[3] + 0.8465834103 * lw[4] * lw[5] + -0.0158943762 * lw[6] * lw[7] +
            0.0001235384 * lw[8] * lw[9];
...
Distance cal_tnf_dist(size_t r1, size_t r2) {
    ...
    __m512d aux512;  //, vec1, vec2, ;
    for (int i = 0; i < 17; i++) {
        // vec1 = _mm512_loadu_pd(TNF + r1 * 136 + i * 8);
        // vec2 = _mm512_loadu_pd(TNF + r2 * 136 + i * 8);
        aux512 = _mm512_sub_pd(_mm512_load_pd(TNF + r1 * 136 + i * 8), _mm512_load_pd(TNF + r2 * 136 + i * 8));
        aux512 = _mm512_mul_pd(aux512, aux512);
        d += _mm512_reduce_add_pd(aux512);
    }
    /*
    for (int i = 0; i < 136; ++i) {
        d += (TNF[r1 * 136 + i] - TNF[r2 * 136 + i]) * (TNF[r1 * 136 + i] - TNF[r2 * 136 + i]);  // euclidean distance
    ...
    */
    ...
    const double _b[] = {46349.1624324381, -76092.3748553155, -639.918334183, 53873.3933743949, -156.6547554844, -21263.6010657275,
                   64.7719132839, 5003.2646455284, -8.5014386744, -700.5825500292, 0.3968284526, 54.037542743, -1.7713972342,
                   474.0850141891, -23.966597785, 0.7800219061, -0.0138723693, 0.0001027543};

    
    b = _b[0];
    b += _mm512_reduce_add_pd(_mm512_mul_pd(_mm512_load_pd(lw), _mm512_load_pd(_b + 1)));
    + -700.5825500292 * lw[8] 
    + 0.3968284526 * lw[9] 
    + 54.037542743 * lw[10] 
    + -1.7713972342 * lw[11] 
    + 474.0850141891 * lw[0] * lw[1] 
    + -23.966597785 * lw[2] * lw[3] 
    + 0.7800219061 * lw[4] * lw[5] 
    + -0.0138723693 * lw[6] * lw[7] 
    + 0.0001027543 * lw[8] * lw[9];
    ...
    + 784.4442123743 * lw[3] 
    + 194712.394138513 * lw[4] 
    + -377.9645994741 * lw[5] 
    + -45088.7863182741 * lw[6] 
    + 50.5960513287 * lw[7] 
    + 6220.3310639927 * lw[8] 
    + -2.3670776453 * lw[9] 
    + -473.269785487 * lw[10] 
    + 15.3213264134 * lw[11] 
    + -3282.8510348085 * lw[0] * lw[1] 
    + 164.0438603974 * lw[2] * lw[3] 
    + -5.2778800755 * lw[4] * lw[5] 
    + 0.0929379305 * lw[6] * lw[7] 
    + -0.0006826817 * lw[8] * lw[9];
